 ...
 * Generation date: Mon Mar 07 09:28:29 2022
 */
...
/**
 * <code>asignatura</code> is a schema class generated by <code>mt_sdl</code>.
 ...
 */
public class asignatura extends academia.clases {
    ...
    /** Class <code>asignatura</code> cache ID */
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("academia.asignatura"));

    /**
     * Gets the <code>asignatura</code> class descriptor.
     ...
     */
    public asignatura(com.matisse.MtDatabase db, int mtOid)  {
        super(db, mtOid);
    }
     ...
     */
    protected asignatura(com.matisse.reflect.MtClass mtCls)  {
        super(mtCls);
    }
    ...
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> instanceIterator(com.matisse.MtDatabase db) {
        return getClass(db).<E>instanceIterator(asignatura.class);
    }
    ...
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> instanceIterator(com.matisse.MtDatabase db, int numObjPerBuffer) {
        return getClass(db).<E>instanceIterator(numObjPerBuffer, asignatura.class);
    }
    ...
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> ownInstanceIterator(com.matisse.MtDatabase db) {
        return getClass(db).<E>ownInstanceIterator(asignatura.class);
    }
    ...
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> ownInstanceIterator(com.matisse.MtDatabase db, int numObjPerBuffer) {
        return getClass(db).<E>ownInstanceIterator(numObjPerBuffer, asignatura.class);
    }
     ...
     * @param db a database
     */
    public asignatura(com.matisse.MtDatabase db) {
        super(getClass(db));
    }
